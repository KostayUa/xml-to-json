...
public class BooleanNodeTest {
    ...
    class ToStringTest {
        ...
        public void booleanNodeToString() {
            Node node = createNode(NODE_NAME1, VALUE2);
            String expected = "BooleanNode(name='" + NODE_NAME1 + "', value='" + VALUE2 + "')";
        ...
        public void booleanNodeToStingWithAttributes() {
            ...
            String expected = "BooleanNode(name='" + NODE_NAME1 + "', value='" + VALUE1 + "', " +
    ...
    private static Node createNode(String name, boolean value, List<Attribute> attributes) {
